           ...
           <v-list>
               ...
               <v-list flat>
                <v-list-item  router to="/">
                   <v-list-item-content>
                       ...
                       <v-list-item-subtitle align="center">Accueil</v-list-item-subtitle>
                   </v-list-item-content>  
               </v-list-item>
              </v-list>
               <v-list flat>
               <v-list-item  router to="/">
                     <v-list-item-content>
                       ...
                       <v-list-item-subtitle align="center">Services</v-list-item-subtitle>
                   </v-list-item-content>  
               </v-list-item>
              </v-list>
              <v-list flat>
               <v-list-item  router to="/">
                    <v-list-item-content>
                       ...
                       <v-list-item-subtitle align="center">À propos</v-list-item-subtitle>
                   </v-list-item-content>  
               </v-list-item>
              </v-list>
              <v-list flat>
